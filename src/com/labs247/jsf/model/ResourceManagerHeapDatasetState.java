 ...
 *
 */
public class ResourceManagerHeapDatasetState {
	@SerializedName("name")
	@Expose
	private String name;
	...
	public ResourceManagerHeapDatasetState() {
		
	}

	public ResourceManagerHeapDatasetState(String name, String modelerType, String tagContext, String tagProcessName,
