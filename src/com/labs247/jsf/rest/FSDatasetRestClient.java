...
public class FSDatasetRestClient {
...
//	String DEFAUT_SERVICE =  "MAPREDUCE2";
	...
	public FSDatasetRestClient(String hostname, String cluster) {
	...
	public String ambari_jmx_client(String host, String port) throws Exception {
		...
		String json = null;
		String URL_JMX_BASIC = "http://" + host + ":" + port + "/jmx?qry=Hadoop:name=FSDatasetState,service=DataNode";
