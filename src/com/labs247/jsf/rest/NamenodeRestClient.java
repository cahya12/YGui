...
public class NamenodeRestClient {
...
//	String DEFAUT_SERVICE =  "MAPREDUCE2";
	...
	public NamenodeRestClient(String hostname, String cluster) {
	...
	public String ambari_jmx_client(String host, String port) throws Exception {
		...
		String json = null;
		String URL_JMX_BASIC = "http://" + host + ":" + port + "/jmx?qry=Hadoop:name=JvmMetrics,service=DataNode";
